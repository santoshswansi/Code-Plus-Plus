...
function Header() {
    ...
    return (
        <div className={`flex items-center justify-between w-screen h-10 !px-6 !py-1 bg-white`}>
            ...
            <Dialog header={"Login"} visible={loginDialogVisible} className='bg-white shadow-md rounded-2xl z-100 !px-6 !py-4' onHide={() => {if (!loginDialogVisible) return; setLoginDialogVisible(false); }}>
                <Login setLoginDialogVisible={setLoginDialogVisible} />
            </Dialog>

            <OverlayPanel ref={logoutOverlapPanel}>
                <div className="!p-2 min-w-50 min-h-20 flex flex-col items-center justify-center rounded-md shadow-[0px_0px_10px_rgba(0,0,0,0.13)] gap-1">
