            ...
            <Splitter className="!border-0">
                ...
                <SplitterPanel>
                    <Splitter layout="vertical">
                        <SplitterPanel className="w-[100%] bg-[#1E1E1E]"><div className="relative w-[100%] h-[100%]"><span className="absolute !mt-2 !ml-2 bg-slate-200 text-black h-7 w-15 rounded-sm text-center !border-0">Input</span><textarea type="text" className="w-[100%] h-[100%] !pt-12 !px-2 text-slate-200 focus:outline-none resize-none" onChange={(e) => setInput(e.target.value)} /></div></SplitterPanel>
                        <SplitterPanel className="w-[100%] bg-[#1E1E1E]"><div className="relative w-[100%] h-[100%]"><span className="absolute !mt-2 !ml-2 bg-slate-200 text-black h-7 w-15 rounded-sm text-center">Output</span><pre className="w-[100%] h-[100%] !pt-12 !px-2 text-slate-200">{output}</pre></div></SplitterPanel>
                    </Splitter>
                </SplitterPanel>
            </Splitter>
